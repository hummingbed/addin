...
const msalConfig = {
  auth: {
    clientId: "e3afd3e2-8b9f-42dc-a85f-aa193d499c07", //This is your client ID
...
async function onMessageComposeHandler(event) {
    ...
    Office.context.mailbox.item.body.setAsync(
      "temporary: setup for signature isn't available yet!!", {
          "asyncContext": event
      },
      ...
      let tokenResponse = userAgentApp.acquireTokenSilent(requestObj)
      console.log('Login Response', tokenResponse);
      
}

Office("onMessageComposeHandler", onMessageComposeHandler);
